...
class GuiWelcome : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        font.drawCenteredString(
            "Press ${Keyboard.getKeyName(LiquidBounce.moduleManager[ClickGUI::class.java].keyBind)} to open up the ClickGUI",
            width / 2F,
            height / 8 + 80F + font.fontHeight * 4,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 5,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 6,
            0xffffff,
            true
        )
        ...
        font.drawCenteredString(
            "§lImportant Commands:",
            width / 2F,
            height / 8F + 80 + font.fontHeight * 8,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 9,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 10,
            0xffffff,
            true
        )
        ...
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 12,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 13,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 14,
            0xffffff,
            true
        )
        font.drawCenteredString(
            ...
            width / 2F,
            height / 8F + 80 + font.fontHeight * 15,
            0xffffff,
            true
        )
