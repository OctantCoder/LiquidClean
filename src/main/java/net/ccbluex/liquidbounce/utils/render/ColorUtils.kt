...
object ColorUtils {
    ...
    @JvmField
    val hexColors: IntArray = IntArray(16)
    ...
    @JvmStatic
    fun rainbow(alpha: Float): Color = rainbow(400000L, alpha)

    @JvmStatic
    fun rainbow(alpha: Int): Color = rainbow(400000L, alpha / 255)

    @JvmStatic
    fun rainbow(offset: Long, alpha: Int): Color = rainbow(offset, alpha.toFloat() / 255)
