...
public class Spammer extends Module {
    ...
    private final BoolValue customValue = new BoolValue("Custom", false);    private final IntegerValue maxDelayValue = new IntegerValue("MaxDelay", 1000, 0, 5000) {
        @Override
    ...
    @EventTarget
    public void onUpdate(@SuppressWarnings("unused") UpdateEvent event) {
