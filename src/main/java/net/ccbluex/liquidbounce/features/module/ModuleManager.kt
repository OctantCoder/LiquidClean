...
class ModuleManager : Listenable {
    ...
    val modules: TreeSet<Module> = TreeSet<Module> { module1, module2 -> module1.name.compareTo(module2.name) }
     ...
     */
    fun getModule(moduleClass: Class<*>): Module = moduleClassMap[moduleClass]!!

    operator fun get(clazz: Class<*>): Module = getModule(clazz)

    /**
     * Get module by [moduleName]
     */
    fun getModule(moduleName: String?): Module? = modules.find { it.name.equals(moduleName, ignoreCase = true) }
